...
void testSmtp() async {
  ...
  final message = Message()
    ...
    ..text = 'Este es un correo de prueba enviado desde una aplicación de Flutter.';

  try {
    final sendReport = await send(message, smtpServer);
    developer.log('Mensaje enviado: ${sendReport.toString()}', name: 'testSmtp');
    ...
    developer.log('Excepción de Mailer capturada', name: 'testSmtp', error: e, stackTrace: s);
  } catch (e, s) {
    developer.log('Se capturó una excepción desconocida', name: 'testSmtp', error: e, stackTrace: s);
  }
}
// coverage:ignore-end
